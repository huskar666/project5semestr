...
export default function Search() {
    ...
    return(
        <section className="search" style={{
         backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(/img/main.png)",
         marginTop: 12,
         ...
         backgroundSize: "cover",
            ...
            <div className="search__container">
                ...
                <div className="search__container--info">
                    <p className="search__container--info--text1">Create your personal list of
                         favorite cities and always be aware of the weather.</p>
                    <div className="search__container--info--line"></div>
                    <p className="search__container--info--text2">{currentTime.toLocaleTimeString() + currentTime.toLocaleDateString()}</p>
                </div>
  ...
  <button className="search__container--searchbox--btn">
    <svg
      width="25"
      height="25"
      viewBox="0 0 24 24"
